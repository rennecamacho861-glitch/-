...
版本：2026-05-11  
对应规则：`CCGS-Data/design/gdd/rulebook.md` v0.8.6 情报真值、开局装备与敌人生态反馈  
...
|---|---|---|---|---|---|
| Simulation Core | `src/sim/GameSimulation.ts` | 局内状态、行动推进、战斗、拾取、AI、掉落、日志、反馈事件 | `SimulationCommandPort`：`move`、`choosePickup`、`useItem`、`playCombatAction`、`tryFlee`、`continueFight`、`tryPersuade`、`reset` | `SimulationReadPort`：`snapshot`、`onChange` | 禁止依赖 DOM、Phaser、CSS |
