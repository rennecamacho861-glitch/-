...
Verify `.ccgs-core/workflows/skills/[name]/SKILL.md` exists. If not, stop with:
...
Look up the skill's `category:` field in `.ccgs-core/tests/catalog.yaml`.
...
Read the full skill file at `.ccgs-core/workflows/skills/[name]/SKILL.md`.
...
Ask: "May I write this improved version to `.ccgs-core/workflows/skills/[name]/SKILL.md`?"
...
Write the improved skill to `.ccgs-core/workflows/skills/[name]/SKILL.md`.
...
Ask: "May I revert `.ccgs-core/workflows/skills/[name]/SKILL.md` using git checkout?"
If yes: run `git checkout -- .ccgs-core/workflows/skills/[name]/SKILL.md`
