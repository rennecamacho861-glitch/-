...
Read `.ccgs-core/docs/technical-preferences.md` and extract:
- `Engine:` value
- `Language:` value
...
Also read:
- `CCGS-Data/design/gdd/systems-index.md` — to know which systems exist
- In-scope GDD(s) — to understand what data types and values need testing
- `CCGS-Data/project-docs/architecture/tr-registry.yaml` — to map requirements to tested systems
...
## Based on: CCGS-Data/design/gdd/combat.md
