...
> Usage: `/team-polish [feature or area]` — specify the feature or area to polish (e.g., `combat`, `main menu`, `inventory system`, `level-1`). 不使用选择题交互; 直接输出 the guidance directly.
