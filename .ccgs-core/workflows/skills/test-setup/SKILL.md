...
1. **Read engine config**:
   - Read `.ccgs-core/docs/technical-preferences.md` and extract the `Engine:` value.
  ...
  test:
    ...
    steps:
      ...
      - name: Run GdUnit4 Tests
        ...
        with:
          godot-version: '[VERSION FROM CCGS-Data/project-docs/engine-reference/godot/VERSION.md]'
          paths: |
            tests/unit
            tests/integration
