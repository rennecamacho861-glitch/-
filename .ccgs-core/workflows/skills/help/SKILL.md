...
Read `.ccgs-core/docs/workflow-catalog.yaml`. This is the authoritative list of all
...
After reading the catalog, Glob `.ccgs-core/workflows/skills/*/SKILL.md` to get the full list
