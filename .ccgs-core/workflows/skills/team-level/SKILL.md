...
**Decision Points:** At each step transition, 向用户呈现选项以 present
...
**Gate**: 向用户呈现选项以 present all three Step 1 outputs (narrative brief, lore foundation, visual direction targets) and confirm before proceeding to Step 2.
...
**Gate**: 向用户呈现选项以 present Step 2 layout (including any unresolved adjacent area dependencies) and confirm before proceeding to Step 3.
...
**Gate**: 向用户呈现选项以 present Step 3 outputs and confirm before proceeding to Step 4.
...
**Gate**: 向用户呈现选项以 present both Step 4 results. If the accessibility-specialist returned any BLOCKING concerns, highlight them prominently and offer:
