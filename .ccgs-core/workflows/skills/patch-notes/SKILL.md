...
1. Check `.ccgs-core/docs/technical-preferences.md` for any "tone", "voice", or "style"
   fields or sections.
...
1. Glob for `docs/patch-notes-template.md` and `.ccgs-core/docs/templates/patch-notes-template.md`.
