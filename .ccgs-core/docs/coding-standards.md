...
- Every system must have corresponding design or architecture coverage in `CCGS-Data/design/gdd/` or `CCGS-Data/project-docs/architecture/`
...
- Each mechanic has a dedicated document or section in `CCGS-Data/design/gdd/`
...
| **Visual/Feel** (animation, VFX, feel) | Screenshot + lead sign-off | `CCGS-Data/production/qa/evidence/` | ADVISORY |
| **UI** (menus, HUD, screens) | Manual walkthrough doc OR interaction test | `CCGS-Data/production/qa/evidence/` | ADVISORY |
| **Config/Data** (balance tuning) | Smoke check pass | `CCGS-Data/production/qa/smoke-[date].md` | ADVISORY |
